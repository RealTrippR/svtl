...
SVTL is a basic vertex transformation library written in C11. It provides a handful of functions to perform simple geometric transformations on vertices.
